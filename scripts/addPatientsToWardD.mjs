/**
 * Script to add 20 queued patients to Ward D
 * Run this while the Next.js dev server is running
 * Usage: node scripts/addPatientsToWardD.mjs
 */
...
async function addPatientsToWardD() {
  console.log("🏥 Adding 20 queued patients to Ward D...\n");
  console.log(
  ...
  console.log("\n✨ Done! Check Ward D's queue in the application.");
}
