/**
 * Script to add 20 queued patients to Ward C
 * Run this while the Next.js dev server is running
 * Usage: node scripts/addPatientsToWardC.mjs
 */
...
async function addPatientsToWardC() {
  console.log("🏥 Adding 20 queued patients to Ward C...\n");
  console.log(
  ...
  console.log("\n✨ Done! Check Ward C's queue in the application.");
}
