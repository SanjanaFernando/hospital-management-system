/**
 * Script to add 20 queued patients to Ward B
 * Run this while the Next.js dev server is running
 * Usage: node scripts/addPatientsToWardB.mjs
 */
...
async function addPatientsToWardB() {
  console.log("🏥 Adding 20 queued patients to Ward B...\n");
  console.log(
  ...
  console.log("\n✨ Done! Check Ward B's queue in the application.");
}
